...
def test_dedup_command_keeps_latest_override_values():
    command = (
        'HF_HOME="/mnt/carles/.cache" python src/jaxformers/train/ntp_with_module.py '
        ...
        'exp_name=test_hf_1 model_name="experimental.gemma3" checkpoint=None '
    ...
    assert dedup_command(command) == (
        ...
        "model_name=experimental.gemma3 checkpoint=None remat_layer=True "
        "project_name=tunix-again exp_name=new_eqx_module_new "
